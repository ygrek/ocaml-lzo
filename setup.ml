...
(* OASIS_START *)
(* DO NOT EDIT (digest: ba71960c119d0190b92a0a488974b34b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["ygrek"];
          homepage = Some "http://ygrek.org.ua/p/ocaml-lzo/";
          bugreports = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["lzo_stubs.c"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-llzo2"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lzo"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "http://git.ocamlcore.org/lzo/lzo.git";
                      src_repo_browser =
                        Some
                          "http://git.ocamlcore.org/cgi-bin/gitweb.cgi?p=lzo/lzo.git";
     ...
     oasis_digest =
       Some "\016\209\209\173\238\240\153\211\017\249\210\255\164jI\203";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
