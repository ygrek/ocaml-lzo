...
(* OASIS_START *)
(* DO NOT EDIT (digest: a219353fde7fe8b4efa0d736141cab56) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["ygrek"];
          homepage = Some "http://lzo.forge.ocamlcore.org/";
     ...
     oasis_digest =
       Some "\155\229\167\186\238\196g\230\016\150\198k\018\1409\029";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
